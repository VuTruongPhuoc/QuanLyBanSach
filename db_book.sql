...
-- Thời gian đã tạo: Th8 11, 2022 lúc 05:08 PM
...
--
-- Cấu trúc bảng cho bảng `table_comments`
--
...
(11, 8, 1, 4, 3, 'ádssds                             \r\n                                s,Quận Đống Đa,Thành phố Hà Nội', '355668062', 'Hongan', '2022-08-09 19:09:59', '2022-08-09 20:53:20'),
(12, 2, 1, 4, 3, 'Đồng Nhân,Quận Đống Đa,Thành phố Hà Nội', '355668062', 'dev dev', '2022-08-10 06:50:39', '2022-08-10 11:16:16'),
(13, 2, 1, 4, 1, 'Đồng Nhân,Quận Đống Đa,Thành phố Hà Nội', '355668062', 'dev dev', '2022-08-10 10:49:27', '2022-08-10 10:49:27');
...
INSERT INTO `table_product` (`id`, `code`, `sub_category_id`, `author_id`, `publisher_id`, `size_id`, `discount_id`, `name`, `short_description`, `long_description`, `quantity`, `price`, `image`, `quantity_page`, `status`, `weight`, `view_count`, `created_at`, `updated_at`, `sale`) VALUES
(1, 'S001', 1, 1, 1, 1, NULL, 'Yêu đê', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.\r\n\r\nTin không? Bạn sẽ cười vỡ bụng cho mà coi! Nhưng nếu bạn nuôi mèo bạn sẽ thấy đúng không để đâu cho hết', 19, '120000', 'img-05.jpg', 232, 1, 1.30, 13, '2022-07-24 05:29:58', '2022-08-10 20:51:23', NULL),
(2, 'S002', 2, 1, 1, 1, NULL, 'Yêu đê 2', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.\r\n\r\nTin không? Bạn sẽ cười vỡ bụng cho mà coi! Nhưng nếu bạn nuôi mèo bạn sẽ thấy đúng không để đâu cho hết', 15, '120000', 'img-01.jpg', 232, 1, 1.30, 91, '2022-07-24 05:30:19', '2022-08-10 21:18:35', NULL),
(3, 'S002', 2, 2, 1, 1, NULL, 'Yêu đê 3', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.', 'Hoàng đế mèo - Con mèo bỉ bựa, đội lên đầu chủ, rất láo nháo nhưng không ai ghét được.\r\n\r\nTin không? Bạn sẽ cười vỡ bụng cho mà coi! Nhưng nếu bạn nuôi mèo bạn sẽ thấy đúng không để đâu cho hết', 17, '120000', 'img-09.jpg', 232, 1, 1.30, 7, '2022-07-24 05:30:30', '2022-08-10 06:50:39', 30),
(4, '06708847', 1, 1, 1, 1, NULL, 'Test', 'ko', 'ko', 12, '120000', 'img-09.jpg', 232, 1, 1.30, 0, '2022-08-11 02:10:05', '2022-08-11 02:11:26', NULL);
...
--
-- Cấu trúc bảng cho bảng `table_saves`
--
...
(12, 'phuoc', 'phuocadmin@gmail.com', NULL, '$2y$10$f9w2uxk8JKHkQ5mhnFnlbuTOgrdrhddGnWFTTO1JtzDdJuNBNATaS', NULL, '2023-08-10 21:05:52', '2023-08-10 21:05:52', 293478234, 'hai duong', 2, 0, 0, '06TTT', '058HH');
...
--
-- Chỉ mục cho bảng `table_comments`
--
...
ALTER TABLE `table_product`
  ...
  ADD KEY `table_product_size_id_foreign` (`size_id`),
  ADD KEY `table_product_discount_id_foreign` (`discount_id`);
...
--
-- Chỉ mục cho bảng `table_saves`
--
ALTER TABLE `table_saves`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT cho bảng `table_comments`
--
ALTER TABLE `table_comments`
...
--
-- AUTO_INCREMENT cho bảng `table_saves`
--
ALTER TABLE `table_saves`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `table_wishlists`
  MODIFY `wish_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
